...
-- at runtime using the environment variable AdventOfCode2025_bindir.
...
-- environment variable AdventOfCode2025_libdir.
...
-- using the environment variable AdventOfCode2025_dynlibdir.
...
-- runtime using the environment variable AdventOfCode2025_datadir.
...
-- variable AdventOfCode2025_libexedir.
...
-- using the environment variable AdventOfCode2025_sysconfdir.
...
libdir     = "/home/bart/.cabal/lib/x86_64-linux-ghc-9.10.3-b976/AdventOfCode2025-1.0.0-inplace-AdventOfCode2025"
dynlibdir  = "/home/bart/.cabal/lib/x86_64-linux-ghc-9.10.3-b976"
datadir    = "/home/bart/.cabal/share/x86_64-linux-ghc-9.10.3-b976/AdventOfCode2025-1.0.0"
libexecdir = "/home/bart/.cabal/libexec/x86_64-linux-ghc-9.10.3-b976/AdventOfCode2025-1.0.0"
sysconfdir = "/home/bart/.cabal/etc"

getBinDir     = catchIO (getEnv "AdventOfCode2025_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "AdventOfCode2025_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "AdventOfCode2025_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "AdventOfCode2025_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "AdventOfCode2025_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "AdventOfCode2025_sysconfdir") (\_ -> return sysconfdir)
